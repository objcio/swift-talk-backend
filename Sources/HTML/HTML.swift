...
public struct El<I> {
    ...
    var block: Bool
    public var children: [ANode<I>]
    
    public init(name: String, block: Bool = true, classes: Class? = nil, attributes: [String:String] = [:], children: [ANode<I>] = []) {
        self.name = name
...
extension ANode {
    public static func html(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "html", classes: classes, attributes: attributes, children: children))
    }
    
    public static func meta(classes: Class? = nil, attributes: [String:String] = [:]) -> ANode {
        return .node(El(name: "meta", block: false, attributes: attributes, children: []))
    }
    
    public static func body(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "body", classes: classes, attributes: attributes, children: children))
    }
    
    public static func p(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode]) -> ANode {
        return .node(El(name: "p", classes: classes, attributes: attributes, children: children))
    }
    
    public static func head(attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "head", attributes: attributes, children: children))
    }
    
    public static func header(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "header", classes: classes, attributes: attributes, children: children))
    }
    
    public static func title(_ text: String) -> ANode {
        return .node(El(name: "title", block: false, children: [.text(text)]))
    }

    public static var br: ANode {
        return .node(El(name: "br", block: false))
    }
    
    public static func span(classes: Class? = nil, attributes: [String:String] = [:], _ text: [ANode]) -> ANode {
        return .node(El(name: "span", block: false, classes: classes, attributes: attributes, children: text))
    }

    public static func strong(classes: Class? = nil, attributes: [String:String] = [:], _ text: [ANode]) -> ANode {
        return .node(El(name: "strong", block: false, classes: classes, attributes: attributes, children: text))
    }

    public static func h1(classes: Class? = nil, attributes: [String:String] = [:], _ title: [ANode]) -> ANode {
        return .node(El(name: "h1", block: false, classes: classes, attributes: attributes, children: title))
    }
    
    public static func h2(classes: Class? = nil, attributes: [String:String] = [:], _ title: [ANode]) -> ANode {
        return .node(El(name: "h2", block: false, classes: classes, attributes: attributes, children: title))
    }
    
    public static func h3(classes: Class? = nil, attributes: [String:String] = [:], _ title: [ANode]) -> ANode {
        return .node(El(name: "h3", block: false, classes: classes, attributes: attributes, children: title))
    }
    
    public static func h4(classes: Class? = nil, attributes: [String:String] = [:], _ title: [ANode]) -> ANode {
        return .node(El(name: "h4", block: false, classes: classes, attributes: attributes, children: title))
    }
    
    public static func img(src: String, alt: String = "", classes: Class? = nil, attributes: [String:String] = [:]) -> ANode {
        var a = attributes
        a["src"] = src
        a["alt"] = alt
    ...
    public static func i(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "i", block: true, classes: classes, attributes: attributes, children: children))
    }
    
    public static func div(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "div", classes: classes, attributes: attributes, children: children))
    }
    
    public static func fieldset(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "fieldset", classes: classes, attributes: attributes, children: children))
    }
    
    public static func label(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "label", classes: classes, attributes: attributes, children: children))
    }
    
    public static func table(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "table", classes: classes, attributes: attributes, children: children))
    }
    
    public static func thead(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "thead", classes: classes, attributes: attributes, children: children))
    }
    
    public static func tbody(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "tbody", classes: classes, attributes: attributes, children: children))
    }
    
    public static func tr(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "tr", classes: classes, attributes: attributes, children: children))
    }
    
    public static func td(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "td", classes: classes, attributes: attributes, children: children))
    }
    
    public static func th(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "th", classes: classes, attributes: attributes, children: children))
    }
    
    public static func input(classes: Class? = nil, name: String, id: String? = nil, type: String = "text",  attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        var a = attributes
        a["type"] = type
        a["name"] = name
        a["id"] = id ?? name
    ...
    public static func textArea(classes: Class? = nil, name: String, id: String? = nil, value: String? = nil, placeHolder: String? = nil, rows: Int? = nil, cols: Int? = nil,  attributes: [String:String] = [:]) -> ANode {
        var a = attributes
        a["name"] = name
        a["id"] = id ?? name
    ...
    public static func form(classes: Class? = nil, action: String, acceptCharset: String = "UTF-8", method: HTTPMethod = .post, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        var a = attributes
        a["action"] = action
    ...
    public static func aside(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "div", classes: classes, attributes: attributes, children: children))
    }
    
    public static func iframe(_ source: URL, attributes: [String:String] = [:]) -> ANode {
        var attrs = attributes
        attrs["src"] = source.absoluteString
        return .node(El(name: "iframe", attributes: attrs))
    }
        
    public static func video(classes: Class? = nil, attributes: [String:String] = [:], _ source: URL, sourceType: String) -> ANode {
    ...
    public static func nav(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "nav", classes: classes, attributes: attributes, children: children))
    }
    
    public static func ul(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "ul", classes: classes, attributes: attributes, children: children))
    }
    
    public static func dl(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "dl", classes: classes, attributes: attributes, children: children))
    }
    
    public static func ol(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "ol", classes: classes, attributes: attributes, children: children))
    }
    
    public static func li(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "li", classes: classes, attributes: attributes, children: children))
    }
    
    public static func dt(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "dt", classes: classes, attributes: attributes, children: children))
    }
    
    public static func dd(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "dd", classes: classes, attributes: attributes, children: children))
    }
    
    public static func button(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "button", classes: classes, attributes: attributes, children: children))
    }
    
    public static func main(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "main", classes: classes, attributes: attributes, children: children))
    }
    
    public static func section(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "section", classes: classes, attributes: attributes, children: children))
    }
    
    public static func article(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "article", classes: classes, attributes: attributes, children: children))
    }
    
    public static func figure(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "figure", classes: classes, attributes: attributes, children: children))
    }
    
    public static func footer(classes: Class? = nil, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        return .node(El(name: "footer", classes: classes, attributes: attributes, children: children))
    }

    public static func script(src: String) -> ANode {
        return .node(El(name: "script", attributes: [
            "src": src
		], children: []))
    }

    public static func script(code: String) -> ANode {
        return .node(El(name: "script", children: [ANode.raw(code)]))
    }
    
    public static func xml(_ name: String, attributes: [String:String] = [:], _ children: [ANode] = []) -> ANode {
        let block: Bool
        if children.isEmpty {
            block = false
    ...
    public static func stylesheet(media: String = "all", href: String) -> ANode {
        let attributes = [
            "rel": "stylesheet",
            "href": href,
            "media": media
    ...
    public static func a(classes: Class? = nil, attributes: [String:String] = [:], _ title: [ANode], href: String) -> ANode {
