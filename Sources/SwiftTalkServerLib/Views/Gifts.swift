    ...
    let contents: [Node] = [
        ...
        .div(classes: "container pt0", [
            .div(classes: "bgcolor-white pa- radius-8 max-width-7 box-sizing-content center stack-", [
                ...
                .div([
                    Node.link(to: .loginWithGithub(continue: Route.gift(.redeem(gift.id))), classes: "mt+ c-button c-button--big c-button--blue c-button--wide", ["Start By Logging In With GitHub"])
                ])
            ])
        ])
    ]
