...
//    func interpret<I: Interp>(id: Id<Episode>) throws -> I where I.RE == STRequestEnvironment {
//        return I.withSession {
//            try self.interpret2(id: id, session: $0)
//        }
//    }
//    
//    private func interpret2<I: Interp>(id: Id<Episode>, session: Session?) throws -> I where I.RE == STRequestEnvironment {
