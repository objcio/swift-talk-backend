...
extension Route.EpisodeR {
    func interpret<I: ResponseRequiringEnvironment>(id: Id<Episode>) throws -> I where I.RE == STRequestEnvironment {
        return .withSession {
            try self.interpret(id: id, session: $0)
        }
    }
    
    private func interpret<I: ResponseRequiringEnvironment>(id: Id<Episode>, session: Session?) throws -> I where I.RE == STRequestEnvironment {
