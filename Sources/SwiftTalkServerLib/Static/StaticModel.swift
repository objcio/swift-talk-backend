...
enum Project: String, Codable, Equatable {
    ...
    case ledgerMacApp
    case genericTableViewControllers
    case typedNotifications
    case collectionProtocols
    case reactiveProgramming
    case serverSideSwift
    case iosAtKickstarter
    case dataStructures
    case xcode9
    ...
    case swiftStrings
    case typeSafeApiWrappers
    case mvcMiniPlayer
    case extensibleLibraries
    case buildingAFormLibrary
    case refactoringLargeViewControllers
    case iosRemoteDebugger
    ...
    case swiftTalkApp
    case buildingACollectionView
    case simdParser
    case buildingAShoppingCart
    case stopWatch
    case retroRampage
    case fromMvcToSwiftUI
    case buildingATemplateLanguage
    case quickOpen
    case swiftUiSlides
    case drawingTrees
    ...
    case pinchTransitions
    case matchedGeometryEffect
    case swiftUiStateExplained
    case asyncSequencesAndStreams
    case staticSiteGenerator
    case largeScrollingGraph
    case structuredConcurrency
    case concurrentWebCrawler
    case advancedAlignment
    case crdts
    case visualizingAsyncAlgorithms
    case buildingAPhotoGrid
    case searchForAMacApp
    case inspectingSwiftUiLayout
    case customComponents
    case iPhoneSimulatorChrome
    case asyncImage
    case staggerdAnimations
    case stickyHeaders
    case scrollViewWithTabs
    case attributedStringBuilder
    case swiftUiStyleBackendLibrary
    case routingWithCodable
    case reimplementingAnchors
    case connectingLinesWithAnchors
    case gitUnderTheHood
    case swiftObservation
